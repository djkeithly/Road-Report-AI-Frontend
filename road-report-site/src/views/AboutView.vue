...
<template>
  <div class="animate-fade-in mx-auto max-w-layout px-6 pb-10 pt-8" style="padding: 2rem 1.5rem;">
    ...
    <section class="relative mb-10 text-center" style="margin-bottom: 2.5rem;">
      ...
      <h1 class="relative mb-3 font-serif text-[44px] font-normal tracking-[-0.035em]" style="margin-bottom: 0.75rem;">About Road Report AI</h1>
    ...
    <section class="pb-10" style="margin-bottom: 2.5rem;">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2" style="display: grid; gap: 1rem;">
        <div v-for="ds in dataSources" :key="ds.name" class="polish-card rounded-[14px] border border-border-0 bg-bg-card shadow-[0_10px_24px_rgba(0,0,0,0.05)] transition-all duration-fast hover:-translate-y-0.5 hover:shadow-[0_16px_30px_rgba(0,0,0,0.07)]" style="padding: 1.25rem;">
    ...
    <section class="pb-10" style="margin-bottom: 2.5rem;">
      ...
      <div class="rounded-[20px] border border-border-0 bg-bg-card shadow-[0_12px_28px_rgba(0,0,0,0.05)]" style="padding: 1.75rem;">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4" style="display: grid; gap: 10px;">
          <div v-for="fc in formulaComponents" :key="fc.name" class="rounded-[10px] border border-border-1 text-center transition-all duration-fast hover:border-border-0 hover:bg-bg-1" style="padding: 14px;">
    ...
    <section class="pb-10" style="margin-bottom: 2.5rem;">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3" style="display: grid; gap: 10px;">
        <div v-for="tech in techStack" :key="tech.name" class="polish-card rounded-[10px] border border-border-0 bg-bg-card shadow-[0_10px_24px_rgba(0,0,0,0.05)] transition-all duration-fast hover:-translate-y-px hover:shadow-[0_14px_28px_rgba(0,0,0,0.06)]" style="display: flex; align-items: center; gap: 0.75rem; padding: 14px 16px;">
    ...
    <section class="pb-10" style="margin-bottom: 2.5rem;">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5" style="display: grid; gap: 0.75rem;">
        <div v-for="member in team" :key="member.initials" class="polish-card rounded-[14px] border border-border-0 bg-bg-card text-center shadow-[0_10px_24px_rgba(0,0,0,0.05)] transition-all duration-fast hover:-translate-y-0.5 hover:shadow-[0_16px_30px_rgba(0,0,0,0.07)]" style="padding: 1.25rem 1rem;">
