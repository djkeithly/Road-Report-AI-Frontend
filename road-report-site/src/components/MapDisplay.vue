<template>
  <div class="relative w-full h-screen bg-gray-50 flex flex-col items-center p-6">
    <div class="mb-4 text-center">
      <h1 class="text-2xl font-bold text-gray-800">Major Roads Highlighter</h1>
      <p v-if="errorMessage" class="text-red-600 font-semibold mt-2 bg-red-100 px-4 py-1 rounded-md inline-block">
        {{ errorMessage }}
      </p>
      <div v-else class="text-gray-600 mt-2 flex gap-4 justify-center">
        <span class="flex items-center gap-1"><span class="w-3 h-3 rounded-full bg-red-500"></span> Highways</span>
        <span class="flex items-center gap-1"><span class="w-3 h-3 rounded-full bg-blue-500"></span> Primary</span>
        <span class="flex items-center gap-1"><span class="w-3 h-3 rounded-full bg-green-500"></span> Secondary</span>
      </div>
    </div>
